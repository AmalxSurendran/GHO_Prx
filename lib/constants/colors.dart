...
///////////////BLUE COLORS//////////////////////////
  ...
  static Color blue = const Color(0xff014EC4);
  static Color blue50 = const Color(0xff014EC4).withOpacity(0.5);
  static Color bluegradient1 = const Color(0xff065FD5);
  static Color bluegradient2 = const Color(0xff064DAB);
  static Color blue2 = const Color(0xff336EBD);
  static Color blue3 = const Color(0xff5486C8);
  ...
  //  const Color(0xff0D2E41)

  ////////////////////// GREY COLORS////////////////////////////

  static Color grey = const Color(0xff909090);
  static Color grey1 = const Color(0xff9CA3AF);
  static Color grey2 = const Color(0xff515151);
  static Color grey3 = const Color(0xff6B7280);
  static Color grey4 = const Color(0xff363636);
  static Color grey5 = const Color(0xff7D8A95);
  static Color grey6 = const Color(0xffDEC4FF);
